...
//            bindPreferenceSummaryToValue(findPreference(PreferenciasDime.VIBRACION_NOTIFICACION));
//            bindPreferenceSummaryToValue(findPreference(PreferenciasDime.SONIDO_NOTIFICACION));
        }
    }
}
